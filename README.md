...
- **Career Workshops**: Resume building, interview preparation, and skill development
...
├── volunteers.html     # Volunteer opportunities
├── press.html          # Press and media coverage
├── sponsors.html       # Sponsor information
├── contact.html        # Contact information
├── footer.html         # Shared footer component
├── styles.css          # Main stylesheet
├── images/            # Image assets
│   ├── logo.png       # ElevateGen logo
│   ├── Team.jpg       # Team photo
│   ├── events/        # Event photos
...
### For Organizations
- Partner with us for student programs
...
- Built connections with impactful mentors and professionals
- Supported students in landing internships and career opportunities
- Created a growing community of motivated students
